package com.oracle.sun.design.image.project1.main;
...
public class Test {
	...
	public static void test2(String path) throws IOException {
		...
		//水印  
		Thumbnails.of(path+"/20120802052832235.jpg").size(1024, 682).watermark(Positions.BOTTOM_RIGHT, ImageIO.read(new File(path+"/qrcode.png")), 0.9f).toFile(path+"/thumb/thumb_watermarkbr_blue.jpg");;  
