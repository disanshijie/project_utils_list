...
public class QRCodeUtil {
     private static final String CHARSET = "utf-8";  
        ...
        private static BufferedImage createImage(String content,BufferedImage logoImage, String bottomDes,
            ...
            hints.put(EncodeHintType.MARGIN, 1); //0没有白边 1加点边框
        ...
        private static void addFontImage(BufferedImage source, String declareText) {
            BufferedImage textImage = FontImage.getImage(declareText, QRCODE_SIZE, 20);
        ...
        * */
        ...
        public static void main(String[] args) throws Exception {  
            String text = "https://blog.csdn.net/w410589502/article/details/72898184";
//            QRCodeUtil.encodeOfPath(text, "d:/test/a1.jpg",null,"d:/test", true);  
//            QRCodeUtil.encode(text,"d:/test"); // 不带logo
            BufferedImage bi = ImageIO.read(new File("D:\\opt\\20120802052832235.jpg")); //logo
            QRCodeUtil.encode(text,bi,"二维码描述","outputname3","d:/opt/thumb", true);
        }  
