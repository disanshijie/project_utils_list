package com.oracle.sun.design.image.project3;
...
public class CreateQRCode {
    public static void main(String[] args) throws IOException {
        ...
        String qrData = "http://t.flashipping.com/webpage/phonePage/travel/public/index.html";//内容信息
        ...
        bufferedImage.flush();
        //设置图片格式，与输出的路径
        ImageIO.write(bufferedImage, "png", new File("D:/opt/qrcode3.png"));
