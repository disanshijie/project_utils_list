package com.oracle.sun.design.email.design.project3;
...
public class SendHTMLMail {
    ...
    public void send(){
        ...
        try {
            //获取模板html文档
            document = reader.read(SendHTMLMail.class.getResource("../project3/pageTemplet.html").getPath());
            ...
            new MailSender.Builder(str.toString(),TO_MAIL).send();
