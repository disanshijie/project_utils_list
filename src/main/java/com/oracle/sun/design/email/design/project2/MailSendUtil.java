...
* @Description: 比较全面了 可以发html 依赖jar： 俩个
* @author sun
* @date 2018年5月14日 下午5:55:24
 */

public class MailSendUtil {
    private final static String host = "smtp.163.com"; //163的服务器
    private final static String formName = "15314537570@163.com";//你的邮箱
    private final static String password = "qwe123asd456"; //授权码
    private final static String replayAddress = "15314537570@163.com"; //接受的邮箱 非发送目标邮箱
    ...
    private static Message getMessage(MailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"sunbo"));
